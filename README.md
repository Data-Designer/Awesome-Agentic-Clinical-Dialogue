...
| **MedCalc-Bench** | 2024       | QA / Calculation    | A dataset focusing on the "computational" aspect of medicine (formulas, risk scores) which LLMs typically struggle with. | [paper](https://arxiv.org/abs/2406.12683), [source](https://github.com/ncbi-nlp/MedCalc-Bench) |
...
| **TeleQnA**       | 2024       | Telemedicine QA     | Real-world style doctor-patient QA benchmark aimed at evaluating LLMs in telemedicine scenarios. | [paper](https://arxiv.org/abs/2310.15507), [source](https://github.com/YuanheTian/TeleQnA) |
